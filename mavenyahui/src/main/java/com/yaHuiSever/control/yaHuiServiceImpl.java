...
public class yaHuiServiceImpl implements yaHuiService{
	...
	public double findfprice() {
		...
		return this.embiz.findfoodprice();
	}
	//查询菜品数量
	@Override
	public double findfnummoney(int foodid,int cid) {
		// TODO Auto-generated method stub
		return this.embiz.findfoodnum(foodid, cid);
	}
	//经理登陆
	@Override
	...
	public List<food> findFoodByM(int typeid) {
		...
		return this.mabiz.findFood(typeid);
	}
	//查看菜品销量业务
	@Override
	...
	public boolean insertorder(int cid, int eid, String orderid,double ordermoney) {
		// TODO Auto-generated method stub
		return this.embiz.increaseorder(cid, eid, orderid, ordermoney);
	}
	//查询订单的方法
	@Override
	public List<order> findAlltorder() {
		return this.embiz.findorder();
	}
	//清空购物车
	@Override
	public boolean DropAllshops() {
		return this.embiz.dropshops();
	}
	//修改购物车单个菜品价格
	@Override
	public boolean updatefmoney(double foodmoney, int foodid) {
		// TODO Auto-generated method stub
		return this.embiz.changefoodmoney(foodmoney, foodid);
	}
	//扣钱
	@Override
	public boolean disMoney(double a, int cid) {
		// TODO Auto-generated method stub
		return this.embiz.disAMoney(a, cid);
	}
